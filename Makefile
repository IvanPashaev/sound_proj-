...
#---------------------------------------------------------------------------------
LIBS		:=	-lya2d -lfont -ltiny3d -lsimdmath -lgcm_sys -lio -lsysutil -lrt -llv2 -lsysmodule \
...
export INCLUDE	:=	$(foreach dir,$(INCLUDES), -I$(CURDIR)/$(dir)) \
					...
					-I$(CURDIR)/include/ya2d/libya2d/include \
...
export LIBPATHS	:=	$(foreach dir,$(LIBDIRS),-L$(dir)/lib) \
					...
					-L$(CURDIR)/include/ya2d/libya2d/lib
